...
#   filename:  dograh-openapi-XXXXXX.json.Vx0rmUP7Md
#   timestamp: 2026-09-17T02:17:01+00:00
...
class TransferAgentConfig(BaseModel):
    ...
    """
    message: Annotated[str | None, Field(max_length=500, title='Message')] = (
...
class TransferAgentToolDefinition(BaseModel):
    ...
    Schema version.
    """
    type: Annotated[Literal['transfer_agent'], Field(title='Type')]
    """
    Tool type.
    """
