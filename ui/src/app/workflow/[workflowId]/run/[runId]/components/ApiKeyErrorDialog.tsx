...
import { API_KEYS_DOC_URL } from "@/constants/documentation";
import { managedModelsLabel } from "@/lib/brand";
                            ...
                            <div className="text-sm space-y-1">
                                ...
                                {isBillingCreditsError && (
                                    <p className="text-muted-foreground">
                                        Purchase credits from Billing to continue using {managedModelsLabel()}-managed models.
                                    </p>
                                )}
                                {isServiceKeyOrgMismatch && (
                                    <a
